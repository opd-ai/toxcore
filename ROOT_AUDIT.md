...
- Total critical issues: 27 high-priority issues remaining (0 in net [FIXED], 0 in noise [FIXED], 0 in capi [FIXED], 0 in noise_demo [FIXED], 0 in async_demo [FIXED], 0 in async_obfuscation_demo [FIXED], 11 in toxav_integration, 0 in file_transfer_demo [2 FIXED], 3 in audio_effects_demo, 3 in multi_transport_demo, 2 in privacy_networks, 5 in toxav_video_call, 1 in net/example [1 FIXED], 2 in net/examples/packet)
