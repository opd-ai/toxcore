...
- Packages needing work: 2 (examples/toxav_video_call, examples/toxav_integration [test coverage remaining])
...
- Total critical issues: 7 high-priority issues remaining (0 in net [FIXED], 0 in noise [FIXED], 0 in capi [FIXED], 0 in noise_demo [FIXED], 0 in async_demo [FIXED], 0 in async_obfuscation_demo [FIXED], 2 in toxav_integration [9 FIXED], 0 in file_transfer_demo [2 FIXED], 0 in audio_effects_demo [3 FIXED], 0 in multi_transport_demo [3 FIXED], 0 in privacy_networks [1 FIXED], 5 in toxav_video_call, 0 in net/example [2 FIXED], 0 in net/examples/packet [2 FIXED])
