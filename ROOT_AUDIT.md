...
8. ~~Test coverage below 65% target in root package (64.3%)~~ (**FIXED**: Root package now at 65.0%, meets target); 0% in async_demo, async_obfuscation_demo, toxav_integration, file_transfer_demo, audio_effects_demo, multi_transport_demo, privacy_networks, toxav_video_call, net/example, and net/examples/packet (acceptable for demo/example code)
