...
func run() error {
	...
	src := generateSource(nodes, time.Now().UTC())
...
// parseAndFilter parses the JSON data and returns filtered, sorted nodes.
// Exported for testing via the parseAndFilter function.
...
func generateSource(nodes []toxNode, timestamp time.Time) string {
