...
- **Security Reviews**: All changes to cryptographic code (`crypto/`, `noise/`, `async/forward_secrecy.go`, `async/obfs.go`) require security-focused review. Follow patterns documented in `docs/SECURITY_AUDIT_REPORT.md`.
