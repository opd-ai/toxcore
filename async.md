You are a distributed systems architect familiar with the Tox protocol. I need your help designing an asynchronous message delivery system for Tox that preserves its strong security properties.
